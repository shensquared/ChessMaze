...
public class EditBoard extends Activity {
  ...
  @Override
    ...
    private final void initUI() {
        ...
        sendButton = (Button)findViewById(R.id.eb_send);
    ...
    private void doMove(Move m) {
        ...
        if (m.from ==-15 && pos.getDestSq() >0){
            pos.setPiece(pos.getDestSq(), piece);
        }
        if (m.from >= 0) {
   ...
   //System.out.println(fen);
            ...
            new Thread(new Runnable() { 
                ...
                String fen = TextIO.toFEN(cb.pos);
                    ...
                    socket = new Socket(Const.IP_ADD_LOCAL, 8888);
    ...
    public void connectToServer()
    {
        try{
            ...
            isa=new InetSocketAddress(Const.IP_ADD_LOCAL,8888);
            client.connect(isa);
    ...
    private void sendMessageToServer()
    {
        ...
        try
        {
            ...
            bytebuf=ByteBuffer.wrap(TextIO.toFEN(cb.pos).getBytes("UTF-8"));
