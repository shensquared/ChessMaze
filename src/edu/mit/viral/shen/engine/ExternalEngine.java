...
package edu.mit.viral.shen.engine;
...
public class ExternalEngine extends UCIEngineBase {
    ...
    protected static final String intSfPath = "/data/data/edu.mit.viral.shen/internal_sf";
    private static final String exePath = "/data/data/edu.mit.viral.shen/engine.exe";
