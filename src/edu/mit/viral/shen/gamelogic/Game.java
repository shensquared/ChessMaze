...
public class Game {
    ...
    public Game(PgnToken.PgnTokenReceiver gameTextListener, TimeControlData tcData, String startPosition) {
...
/*
    ...
    public Game(PgnToken.PgnTokenReceiver gameTextListener, TimeControlData tcData, long game_id) {
        this.gameTextListener = gameTextListener;
        timeController = new TimeControl();
        timeController.setTimeControl(tcData);
        gamePaused = false;
...
*/
    ...
    public final void newGame(String startPosition) {
        tree = new GameTree(gameTextListener, startPosition);
        timeController.reset();
        pendingDrawOffer = false;
        updateTimeControl(true);
    }
/*
    public final void newGame(long game_id) {
        tree = new GameTree(gameTextListener, game_id);
        timeController.reset();
        pendingDrawOffer = false;
        updateTimeControl(true);
    }
